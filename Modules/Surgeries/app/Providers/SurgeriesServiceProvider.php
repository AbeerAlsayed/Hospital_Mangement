...
namespace Modules\Surgeries\Providers;

use Illuminate\Support\Facades\Blade;
use Illuminate\Support\ServiceProvider;
use Nwidart\Modules\Traits\PathNamespace;

class SurgeriesServiceProvider extends ServiceProvider
{
    use PathNamespace;

    protected string $name = 'Surgeries';

    protected string $nameLower = 'surgeries';
